...
def years_ago(date):
    ...
    date_var = datetime.strptime(date, '%d %b, %Y')
    date_year = date_var.year
    sol_year = THIS_YEAR - date_year
    return sol_year
...
if __name__ == '__main__':
    print(type(years_ago('31 Dec, 1958')))
    print((years_ago('31 Dec, 1958')))
    print(type(convert_eu_to_us_date('41/03/2002')))
